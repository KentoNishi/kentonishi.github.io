...
//      console.log(errorCode+" - "+errorMessage+" - "+email+" - "+credential);
  ...
  function ask(question, callback){
    document.body.innerHTML+="<div class='prompt'><h1>"+question+"</h1><br /><input class='answer'></input><button onclick='"+callback+"(document.querySelectorAll("+'".'+question+'"'+")[0].value);document.querySelectorAll("+'".prompt"'+")[0].outerHTML="+'""'+";'>OK</button></div>";
  }
