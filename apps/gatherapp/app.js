...
function loadUser(id){
  var editable="";
  var signOut="";
  if(id==uid){editable='contenteditable onkeypress="'+decodeURIComponent("function(event)%7Bif(event.keyCode%3D%3D13)%7BwriteUser(document.querySelectorAll('span%5Bcontenteditable%5D')%5B0%5D.innerHTML)%3Breturn%20false%3B%7D")+'"';signOut="<br /><a href='javascript:writeUser(document.querySelectorAll("+'"span[contenteditable]"'+")[0].innerHTML);'>Save</a><br /><br /><a href='javascript:signOut();'>Sign Out</a>";}
