...
function loadUser(name,email,pic,desc){
  document.querySelectorAll(".body")[0].innerHTML=('<div class="card"><span style="font-size:8vh;">'+encode(name)+'</span><br /><img class="pic" alt="Profile Picture" src="'+pic+'"></img><br /><br /><span'+checkme(1)+'>'+encode(desc)+'</span><br />'+checkme(2)+'</div>');
}
